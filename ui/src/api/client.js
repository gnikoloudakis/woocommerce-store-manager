...
export const fetchOrdersOverview      = (period = 'month', compare = true) => api.get('/dashboard/orders/overview', { params: { period, compare } }).then(r => r.data)
export const fetchNeedsAttention      = () => api.get('/dashboard/needs-attention').then(r => r.data)
export const fetchOrdersHeatmap       = (days = 90) => api.get('/dashboard/orders/heatmap', { params: { days } }).then(r => r.data)
export const fetchTopCustomers        = (period = 'month', limit = 10) => api.get('/dashboard/customers/top', { params: { period, limit } }).then(r => r.data)
export const fetchOrdersSparkline     = (days = 30) => api.get('/dashboard/orders/sparkline', { params: { days } }).then(r => r.data)
export const fetchInventoryStats      = () => api.get('/dashboard/inventory/stats').then(r => r.data)
